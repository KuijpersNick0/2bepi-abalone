class board(object): 
    ...
    def legal_plays(self, states):
        #Prend une séquence d'états de jeu représentant l'historique complet du jeu et renvoie la liste complète des coups qui sont des jeux légaux pour le joueur actuel.
        moves = []
        moves.append(self.moves)
        return moves
